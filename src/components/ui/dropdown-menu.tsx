...
function DropdownMenuTrigger({ asChild, children, ...props }: MenuPrimitive.Trigger.Props & { asChild?: boolean }) {
  if (asChild && React.isValidElement(children)) {
    // base-ui uses `render` prop instead of Radix's asChild pattern
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    return <MenuPrimitive.Trigger data-slot="dropdown-menu-trigger" render={children as any} {...(props as any)} />
  }
